...
public class KhoaHocJFrame extends javax.swing.JFrame {
    ...
    void fillComboBoxChuyenDe(){
        ...
        for (ChuyenDe cd : list) {
            model.addElement(cd); // đổ dữ liệu vào combo box
        }
    ...
    void fillToTable(){
        ...
        try {
            ...
            for (KhoaHoc kh : list) {
                Object[] row = {kh.getMaKH(), kh.getMaCD() ,kh.getThoiLuong(), kh.getHocPhi() ,DateHelper.toString(kh.getNgayKG(),"dd/MM/yyyy"), kh.getMaNV(), DateHelper.toString(kh.getNgayTao(),"dd/MM/yyyy")};
                model.addRow(row);
            }
        } catch (Exception e) {
